...
import { IETARepository, ETA_REPOSITORY } from '../repositories/eta.repository.interface';
import { ILocationRepository, LOCATION_REPOSITORY } from '../repositories/location.repository.interface';
import { ISchoolRepository, SCHOOL_REPOSITORY } from '../repositories/school.repository.interface';
import { IParentRepository, PARENT_REPOSITORY } from '../repositories/parent.repository.interface';
